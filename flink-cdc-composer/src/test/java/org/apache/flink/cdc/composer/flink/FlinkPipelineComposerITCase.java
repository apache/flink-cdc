    ...
    void testMergingWithRoute() throws Exception {
        ...
        assertThat(outputEvents)
                .containsExactly(
                        ...
                        "AlterColumnTypeEvent{tableId=default_namespace.default_schema.merged, typeMapping={age=BIGINT, id=BIGINT}, oldTypeMapping={age=INT, id=INT}, columnDefaultValue={}}",
