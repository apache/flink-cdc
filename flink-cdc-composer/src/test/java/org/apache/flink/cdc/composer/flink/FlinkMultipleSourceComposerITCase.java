...
class FlinkMultipleSourceComposerITCase {
    ...
    void testSingleSplitMultipleSources() throws Exception {
        ...
        assertThat(outputEvents)
                .contains(
                        "CreateTableEvent{tableId=default_namespace3.default_schema3.table3, schema=columns={`col1` STRING,`col2` STRING}, primaryKeys=col1, options=()}\r",
                        "DataChangeEvent{tableId=default_namespace3.default_schema3.table3, before=[], after=[1, 1, null], op=INSERT, meta=()}\r",
                        "DataChangeEvent{tableId=default_namespace3.default_schema3.table3, before=[], after=[2, 2, null], op=INSERT, meta=()}\r",
                        "DataChangeEvent{tableId=default_namespace3.default_schema3.table3, before=[], after=[3, 3, null], op=INSERT, meta=()}\r",
                        "AddColumnEvent{tableId=default_namespace3.default_schema3.table3, addedColumns=[ColumnWithPosition{column=`col3` STRING, position=LAST, existedColumnName=null}]}\r",
                        "CreateTableEvent{tableId=default_namespace4.default_schema4.table4, schema=columns={`col1` STRING,`col2` STRING}, primaryKeys=col1, options=()}\r",
                        "DataChangeEvent{tableId=default_namespace4.default_schema4.table4, before=[], after=[1, 1, null], op=INSERT, meta=()}\r",
                        "DataChangeEvent{tableId=default_namespace4.default_schema4.table4, before=[], after=[2, 2, null], op=INSERT, meta=()}\r",
                        "DataChangeEvent{tableId=default_namespace4.default_schema4.table4, before=[], after=[3, 3, null], op=INSERT, meta=()}",
                        "AddColumnEvent{tableId=default_namespace4.default_schema4.table4, addedColumns=[ColumnWithPosition{column=`col4` STRING, position=LAST, existedColumnName=null}]}\r");
    }
