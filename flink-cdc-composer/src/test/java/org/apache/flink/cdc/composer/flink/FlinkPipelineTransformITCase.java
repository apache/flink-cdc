    ...
    void testVanillaTransformWithSchemaEvolution() throws Exception {
        ...
        assertThat(outputEvents)
                .containsExactly(
                        ...
                        "AlterColumnTypeEvent{tableId=default_namespace.default_schema.mytable1, typeMapping={gender=INT, name=VARCHAR(17), age=DOUBLE}, oldTypeMapping={gender=TINYINT, name=STRING, age=INT}, columnDefaultValue={}}",
    ...
    void testExplicitTransformWithSchemaEvolution() throws Exception {
        ...
        assertThat(outputEvents)
                .containsExactly(
                        ...
                        "AlterColumnTypeEvent{tableId=default_namespace.default_schema.mytable1, typeMapping={name=VARCHAR(17)}, oldTypeMapping={name=STRING}, columnDefaultValue={}}",
