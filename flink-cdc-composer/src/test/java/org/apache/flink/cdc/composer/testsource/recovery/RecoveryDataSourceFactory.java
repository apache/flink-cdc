...
/** Factory for {@link RecoveryDataSource}. */
public class RecoveryDataSourceFactory implements DataSourceFactory {

    public static final String IDENTIFIER = "recovery-test-source";
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        return ImmutableSet.of(PARALLEL_METADATA_SOURCE);
    }
}
