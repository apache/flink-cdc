 ...
 */
@Internal
public interface TypeSerializerSnapshotAdapter<T> extends TypeSerializerSnapshot<T> {
    ...
    default TypeSerializerSchemaCompatibility<T> resolveSchemaCompatibility(
        ...
        return resolveSchemaCompatibility(typeSerializerSnapshot.restoreSerializer());
    }
}
