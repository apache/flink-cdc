...
|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| [mongodb-cdc](connectors/CDC_Source_Connectors/mongodb-cdc.md)     | <li> [MongoDB](https://www.mongodb.com): 3.6, 4.x, 5.0                                                                                                                                                                                                                                                                                                                                                 | MongoDB Driver: 4.3.4     |
| [mysql-cdc](connectors/CDC_Source_Connectors/mysql-cdc.md)         | <li> [MySQL](https://dev.mysql.com/doc): 5.6, 5.7, 8.0.x <li> [RDS MySQL](https://www.aliyun.com/product/rds/mysql): 5.6, 5.7, 8.0.x <li> [PolarDB MySQL](https://www.aliyun.com/product/polardb): 5.6, 5.7, 8.0.x <li> [Aurora MySQL](https://aws.amazon.com/cn/rds/aurora): 5.6, 5.7, 8.0.x <li> [MariaDB](https://mariadb.org): 10.x <li> [PolarDB X](https://github.com/ApsaraDB/galaxysql): 2.0.1 | JDBC Driver: 8.0.28       |
| [oceanbase-cdc](connectors/CDC_Source_Connectors/oceanbase-cdc.md) | <li> [OceanBase CE](https://open.oceanbase.com): 3.1.x, 4.x <li> [OceanBase EE](https://www.oceanbase.com/product/oceanbase): 2.x, 3.x, 4.x                                                                                                                                                                                                                                                            | OceanBase Driver: 2.4.x   |
| [oracle-cdc](connectors/CDC_Source_Connectors/oracle-cdc.md)       | <li> [Oracle](https://www.oracle.com/index.html): 11, 12, 19, 21                                                                                                                                                                                                                                                                                                                                       | Oracle Driver: 19.3.0.0   |
| [postgres-cdc](connectors/CDC_Source_Connectors/postgres-cdc.md)   | <li> [PostgreSQL](https://www.postgresql.org): 9.6, 10, 11, 12, 13, 14                                                                                                                                                                                                                                                                                                                                 | JDBC Driver: 42.5.1       |
| [sqlserver-cdc](connectors/CDC_Source_Connectors/sqlserver-cdc.md) | <li> [Sqlserver](https://www.microsoft.com/sql-server): 2012, 2014, 2016, 2017, 2019                                                                                                                                                                                                                                                                                                                   | JDBC Driver: 9.4.1.jre8   | 
| [tidb-cdc](connectors/CDC_Source_Connectors/tidb-cdc.md)           | <li> [TiDB](https://www.pingcap.com/): 5.1.x, 5.2.x, 5.3.x, 5.4.x, 6.0.0                                                                                                                                                                                                                                                                                                                               | JDBC Driver: 8.0.27       | 
| [db2-cdc](connectors/CDC_Source_Connectors/db2-cdc.md)             | <li> [Db2](https://www.ibm.com/products/db2): 11.5                                                                                                                                                                                                                                                                                                                                                     | Db2 Driver: 11.5.0.0      |
| [vitess-cdc](connectors/CDC_Source_Connectors/vitess-cdc.md)       | <li> [Vitess](https://vitess.io/): 8.0.x, 9.0.x                                                                                                                                                                                                                                                                                                                                                        | MySql JDBC Driver: 8.0.26 |
...
|----------------------------------------------|--------------|---------------|-------------------|---------------------------|
| [mongodb-cdc](connectors/CDC_Source_Connectors/mongodb-cdc.md)     | ✅            | ✅             | ✅                 | ✅                         |
| [mysql-cdc](connectors/CDC_Source_Connectors/mysql-cdc.md)         | ✅            | ✅             | ✅                 | ✅                         |
| [oracle-cdc](connectors/CDC_Source_Connectors/oracle-cdc.md)       | ✅            | ✅             | ✅                 | ✅                         |
| [postgres-cdc](connectors/CDC_Source_Connectors/postgres-cdc.md)   | ✅            | ✅             | ✅                 | ✅                         |
| [sqlserver-cdc](connectors/CDC_Source_Connectors/sqlserver-cdc.md) | ✅            | ✅             | ✅                 | ✅                         |
| [oceanbase-cdc](connectors/CDC_Source_Connectors/oceanbase-cdc.md) | ❌            | ❌             | ❌                 | ❌                         |
| [tidb-cdc](connectors/CDC_Source_Connectors/tidb-cdc.md)           | ✅            | ❌             | ✅                 | ❌                         |
| [db2-cdc](connectors/CDC_Source_Connectors/db2-cdc.md)             | ❌            | ❌             | ✅                 | ❌                         |
| [vitess-cdc](connectors/CDC_Source_Connectors/vitess-cdc.md)       | ✅            | ❌             | ✅                 | ❌                         |
