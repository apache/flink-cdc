...
<table class="colwidths-auto docutils">
     ...
     <tr>
       ...
       <td> Parameters of StreamLoad.
         ...
         See more about <a href="https://doris.apache.org/zh-CN/docs/dev/data-operate/import/import-way/stream-load-manual"> StreamLoad Properties</a></td>
       </td>
     </tr>
     <tr>
       ...
       <td>Create the Properties configuration of the table.
         ...
         See more about <a href="https://doris.apache.org/zh-CN/docs/dev/sql-manual/sql-statements/table-and-view/table/CREATE-TABLE"> Doris Table Properties</a></td>
       </td>
     </tr>
     </tbody>
</table>
