...
<table class="colwidths-auto docutils">
    ...
    <tr>
      ...
      <td style="word-wrap: break-word;">true</td>
      <td>Boolean</td>
      <td>Whether to sync NOT NULL clauses generated from upstream column nullability in Doris schema change DDL. If false, Doris DDL generated by the pipeline sink does not append NOT NULL for upstream non-null columns.</td>
    </tr>
    <tr>
      ...
      <td style="word-wrap: break-word;">true</td>
      <td>Boolean</td>
      <td>Whether to sync DEFAULT value clauses in generated Doris CREATE TABLE and ADD COLUMN DDL. If false, default values are omitted from Doris DDL.</td>
    </tr>
    <tr>
