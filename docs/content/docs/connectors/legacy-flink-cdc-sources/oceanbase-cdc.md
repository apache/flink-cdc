...
Note:
- For users of OceanBase CE or OceanBase EE MySQL Mode, we recommend that you follow the [MySQL CDC documentation](mysql-cdc.md) to use the MySQL CDC source connector with the Binlog service.
- When you want to use a supported driver other than the builtin one, you need to manually introduce it to your application.
