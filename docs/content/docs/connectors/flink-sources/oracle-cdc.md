...
Download [flink-sql-connector-oracle-cdc-{{ flinkCDCVersion }}.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-oracle-cdc/{{ flinkCDCVersion }}/flink-sql-connector-oracle-cdc-{{ flinkCDCVersion }}.jar) and put it under `<FLINK_HOME>/lib/`.
