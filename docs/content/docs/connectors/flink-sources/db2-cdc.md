...
Download [flink-sql-connector-db2-cdc-{{ flinkCDCVersion }}.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-db2-cdc/{{ flinkCDCVersion }}/flink-sql-connector-db2-cdc-{{ flinkCDCVersion }}.jar) and 
...
The DB2 CDC incremental connector (after {{ flinkCDCVersion }}) can be used as the following shows:
```java
