...
Download [flink-sql-connector-mongodb-cdc-{{ flinkCDCVersion }}.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-mongodb-cdc/{{ flinkCDCVersion }}/flink-sql-connector-mongodb-cdc-{{ flinkCDCVersion }}.jar) and put it under `<FLINK_HOME>/lib/`.
