...
| `transform.expression.semantics` | The semantics used to evaluate transform expressions. One of: `DEFAULT` (default, preserves current behavior) or `FLINK_SQL` (uses Flink SQL-compatible semantics for supported predicates).                                                                                                                                                                                                                                                                                                         | optional          |
