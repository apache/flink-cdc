...
| `flink-conf`                               | Used to configure [Flink-related parameters](https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/config/). <br/>Configuration priority: CLI arguments > pipeline.yaml > Flink config.yaml. Both flat key-value pairs and nested YAML structure are supported.                                                                                                                                                                                                                            | optional          |
