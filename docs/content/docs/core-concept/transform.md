...
| OVERLAY(string1 PLACING string2 FROM integer1 [FOR integer2]) | overlay(string1, string2, integer1[, integer2])  | Replaces a substring of STRING1 with STRING2 from position integer1. The replaced length defaults to the length of STRING2.                                                                        |
| POSITION(string1 IN string2)                                | position(string1, string2)                       | Returns the position of the first occurrence of STRING1 in STRING2. The first position is 1. Returns 0 if not found.                                                                               |
...
| TO_BASE64(string)                                           | toBase64(string)                                 | Encodes STRING to a base64 string.                                                                                                                                                                |
| FROM_BASE64(string)                                         | fromBase64(string)                               | Decodes a base64 string.                                                                                                                                                                          |
