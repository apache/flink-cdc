...
Download [flink-format-changelog-json-2.0.2.jar](https://repo1.maven.org/maven2/com/ververica/flink-format-changelog-json/2.0.2/flink-format-changelog-json-2.0.2.jar) and put it under `<FLINK_HOME>/lib/`.
