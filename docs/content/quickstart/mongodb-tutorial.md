...
```Download links are available only for stable releases.```
 ...
 - [flink-sql-connector-mongodb-cdc-2.2-SNAPSHOT.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-mongodb-cdc/2.2-SNAPSHOT/flink-sql-connector-mongodb-cdc-2.2-SNAPSHOT.jar)
