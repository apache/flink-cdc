...
```Download links are available only for stable releases.```
 ...
 - [flink-sql-connector-mongodb-cdc-2.1.1.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-mongodb-cdc/2.1.1/flink-sql-connector-postgres-cdc-2.1.1.jar)
