...
Download [flink-sql-connector-postgres-cdc-2.0.2.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-postgres-cdc/2.0.2/flink-sql-connector-postgres-cdc-2.0.2.jar) and put it under `<FLINK_HOME>/lib/`.
