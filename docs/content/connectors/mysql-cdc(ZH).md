...
<<<<<<< HEAD
**Notes:** flink-sql-connector-mysql-cdc-XXX 快照版本是开发分支对应的代码。用户需要下载源代码并编译相应的 jar。用户应使用发布的版本，例如 [flink-sql-connector-mysql-cdc-XXX.jar](https://mvnrepository.com/artifact/com.ververica/flink-connector-mysql-cdc)，当前已发布的所有版本都已在 Maven 中央仓库中提供。
=======
**Notes:** flink-sql-connector-mysql-cdc-XXX 快照版本是开发分支对应的代码。用户需要下载源代码并编译相应的 jar。用户应使用发布的版本，例如[flink-sql-connector-mysql-cdc-XXX.jar](https://mvnrepository.com/artifact/com.ververica/flink-connector-mysql-cdc)，当前已发布的所有版本都已在 Maven 中央仓库中提供。
>>>>>>> origin/translate_mysql-cdc-doc
