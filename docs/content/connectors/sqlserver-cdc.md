...
Download [flink-sql-connector-sqlserver-cdc-2.2.1.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-sqlserver-cdc/2.2.1/flink-sql-connector-sqlserver-cdc-2.2.1.jar) and put it under `<FLINK_HOME>/lib/`.
