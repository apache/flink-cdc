...
| `flink-conf`                  | 用于配置[Flink 相关参数](https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/config/)。 <br/>Flink 参数生效优先级（由高到低）为 CDC CLI 命令行参数、Pipeline YAML 块、Flink `config.yaml`。                                                                                                                                                                                                                                                                                                                 | optional          |
