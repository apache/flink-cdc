...
- [flink-sql-connector-tidb-cdc-{{ flinkCDCVersion }}.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-tidb-cdc/{{ flinkCDCVersion }}/flink-sql-connector-tidb-cdc-{{ flinkCDCVersion }}.jar)
