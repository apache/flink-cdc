...
- [flink-sql-connector-oceanbase-cdc-{{ flinkCDCVersion }}.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-oceanbase-cdc/{{ flinkCDCVersion }}/flink-sql-connector-oceanbase-cdc-{{ flinkCDCVersion }}.jar)
