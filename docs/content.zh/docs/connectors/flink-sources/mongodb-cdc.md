...
下载 [flink-sql-connector-mongodb-cdc-{{ flinkCDCVersion }}.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-mongodb-cdc/{{ flinkCDCVersion }}/flink-sql-connector-mongodb-cdc-{{ flinkCDCVersion }}.jar)， 把它放在 `<FLINK_HOME>/lib/`.
