    ...
    <table class="colwidths-auto docutils">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    MySQL Driver: 5.1.47 (内置), 8.0.x <br>
...
注意:
- 对于使用 OceanBase 社区版或 OceanBase 企业版 MySQL 模式的用户，我们推荐参考  [MySQL CDC 的文档](mysql-cdc.md)，使用 MySQL CDC 连接器搭配 Binlog 服务。
- 当您希望使用内置驱动以外的 JDBC 驱动时，您需要手动将其引入到项目中。
