...
public class FlinkEnvironmentUtils {
    ...
    private static void mergeCommandLineFlinkConfig(
        ...
        Optional.ofNullable(commandLine.getOptionValue(SAVEPOINT_CLAIM_MODE))
                .ifPresent(value -> RestoreModeAdapter.setRestoreMode(flinkConfig, value));
        ...
        LOG.info(
                "Dynamic Flink configuration items found from command line: {}",
    ...
    private static void mergePipelineFlinkConfig(Path pipelineDefPath, Configuration flinkConfig)
            throws IOException {
        Configuration flinkConfigFromPipelineDef =
                Configuration.fromMap(
                        YamlPipelineDefinitionParser.getFlinkConfigFromPipelineDef(
                                pipelineDefPath));
        LOG.info(
                "Flink configuration items found from pipeline definition: {}",
    ...
    public static SavepointRestoreSettings createSavepointRestoreSettings(
        ...
        RestoreModeAdapter.getSavepointPath(flinkConfig)
                .ifPresent(
                        savepointPath -> LOG.info("Load savepoint from path: {}", savepointPath));
        return RestoreModeAdapter.createSavepointRestoreSettings(flinkConfig);
    }
}
