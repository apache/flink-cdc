...
public class JdbcSourceOptions extends SourceOptions {
    ...
    public static final ConfigOption<String> USERNAME =
            ConfigOptions.key("username")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Name of the database to use when connecting to the jdbc database server.");
    ...
    public static final ConfigOption<String> PASSWORD =
            ConfigOptions.key("password")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Password to use when connecting to the jdbc database server.");

    public static final ConfigOption<String> DATABASE_NAME =
            ConfigOptions.key("database-name")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Database name of the jdbc server to monitor.");

    public static final ConfigOption<String> TABLE_NAME =
            ConfigOptions.key("table-name")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("Table name of the jdbc database to monitor.");
    ...
    public static final ConfigOption<Duration> CONNECT_TIMEOUT =
            ConfigOptions.key("connect.timeout")
                    ...
                    .withDescription(
                            "The maximum time that the connector should wait after trying to connect to the jdbc database server before timing out.");
    ...
    public static final ConfigOption<Integer> CONNECT_MAX_RETRIES =
            ConfigOptions.key("connect.max-retries")
                    ...
                    .defaultValue(3)
                    .withDescription(
                            "The max retry times that the connector should retry to build jdbc database server connection.");
}
