...
public class MongoDB6Container extends org.testcontainers.containers.MongoDBContainer {
    ...
    MongoDB6Container(String imageName) {
        super(imageName);
    }

    @Override
    public MongoDB6Container withSharding() {
        return (MongoDB6Container) super.withSharding();
    }

    @Override
    public MongoDB6Container withLogConsumer(Consumer<OutputFrame> consumer) {
        return (MongoDB6Container) super.withLogConsumer(consumer);
    }
