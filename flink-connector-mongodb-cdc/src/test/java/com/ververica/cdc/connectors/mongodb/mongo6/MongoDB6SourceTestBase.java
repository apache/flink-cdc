...
public class MongoDB6SourceTestBase {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MongoDB6SourceTestBase.class);

    @ClassRule
    public static final MongoDB6Container CONTAINER =
            new MongoDB6Container("mongo:6.0.6")
                    .withSharding()
