...
public class MongoDBSourceOptions {
    ...
    @Experimental
    public static final ConfigOption<Boolean> SCAN_NEWLY_ADDED_COLLECTION_ENABLED =
            ConfigOptions.key("scan.newly-added-collection.enabled")
                    .booleanType()
                    .defaultValue(false)
                    .withDescription(
                            "Whether capture the scan the newly added collections or not, Defaults to false.");
}
