...
@Experimental
public class MongoDBChunkSplitter implements ChunkSplitter<CollectionId, CollectionSchema> {
    ...
    @Override
    public Collection<SnapshotSplit<CollectionId, CollectionSchema>> generateSplits(
