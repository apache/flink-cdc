...
public class MongoDBTableSource implements ScanTableSource, SupportsReadingMetadata {
    ...
    public MongoDBTableSource(
            ...
            @Nullable Boolean scanNewlyAddedCollectionEnabled) {
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext scanContext) {
        ...
        if (enableParallelRead) {
            ...
            Optional.ofNullable(scanNewlyAddedCollectionEnabled)
                    .ifPresent(builder::scanNewlyAddedCollectionEnabled);
            ...
            if (Boolean.TRUE.equals(scanNewlyAddedCollectionEnabled)) {
                LOG.warn(
                        "newly-added-collection feature is only supported when parallelism snapshot is enabled: "
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(physicalSchema, that.physicalSchema)
                ...
                && Objects.equals(
                        scanNewlyAddedCollectionEnabled, that.scanNewlyAddedCollectionEnabled)
