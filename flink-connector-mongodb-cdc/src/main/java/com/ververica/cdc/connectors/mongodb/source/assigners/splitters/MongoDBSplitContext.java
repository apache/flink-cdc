...
/**
 * The split context used by {@link MongoDBSplitter} to split collection into a set of chunks for
 * MongoDB data source.
 */
public class MongoDBSplitContext {
    ...
    public static MongoDBSplitContext of(
            MongoDBSourceConfig sourceConfig, int currentParallelism, CollectionId collectionId) {
        MongoClient mongoClient = clientFor(sourceConfig);
        return new MongoDBSplitContext(
                mongoClient,
                currentParallelism,
                collectionId,
