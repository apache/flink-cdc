...
public final class MongoDBRecordEmitter<T>
        implements RecordEmitter<
                SourceRecord, T, SourceSplitState<CollectionId, CollectionSchema>> {
    ...
    public void emitRecord(
            ...
            SourceSplitState<CollectionId, CollectionSchema> splitState)
            throws Exception {
        if (isHeartbeatEvent(element)) {
            if (splitState.isStreamSplitState()) {
                ...
                StreamSplitState<CollectionId, CollectionSchema> streamSplitState =
                        splitState.asStreamSplitState();
