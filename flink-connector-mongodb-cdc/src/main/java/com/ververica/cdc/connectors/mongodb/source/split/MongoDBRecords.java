 ...
 */
public final class MongoDBRecords implements RecordsWithSplitIds<SourceRecord> {
    ...
    public static MongoDBRecords forRecords(
            final String splitId, final Iterator<SourceRecord> recordsForSplit) {
        return new MongoDBRecords(splitId, recordsForSplit, Collections.emptySet());
    }

    public static MongoDBRecords forFinishedSplit(final String splitId) {
        return new MongoDBRecords(null, null, Collections.singleton(splitId));
    }
}
