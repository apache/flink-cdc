...
public class ChunkUtils {
    ...
    public static BsonDocument boundOf(String splitKey, BsonValue bound) {
        return new BsonDocument(splitKey, bound);
    }

    public static BsonDocument minLowerBound(String splitKey) {
        return boundOf(splitKey, BSON_MIN_KEY);
    }

    public static BsonDocument maxUpperBound(String splitKey) {
