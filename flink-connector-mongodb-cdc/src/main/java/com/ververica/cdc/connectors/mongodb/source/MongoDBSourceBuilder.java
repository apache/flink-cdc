...
public class MongoDBSourceBuilder<T> {
     ...
     * scan.parallelism.snapshot.chunk.size.mb
     *
     * <p>Whether capture the scan the newly added collections or not. Default: false.
     */
    public MongoDBSourceBuilder<T> scanNewlyAddedCollectionEnabled(
            boolean scanNewlyAddedCollectionEnabled) {
        this.configFactory.scanNewlyAddedCollectionEnabled(scanNewlyAddedCollectionEnabled);
        return this;
    }
