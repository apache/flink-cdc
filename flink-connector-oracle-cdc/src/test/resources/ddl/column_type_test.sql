...
create table DEBEZIUM.FULL_TYPES (
    ...
    VAL_NUMBER_2_P_4_SCALE       NUMBER(2, 4),
    VAL_NUMBER_1_P_38_SCALE      NUMBER(1, 38),
    VAL_NUMBER_3_P_37_SCALE      NUMBER(3, 38),
    VAL_DATE                     DATE,
    VAL_TS                       TIMESTAMP(6),
...
INSERT INTO DEBEZIUM.FULL_TYPES VALUES (
    ...
    0.0099, 0.00000000000000000000000000000000000009, 0.000000000000000000000000000000000000999,
