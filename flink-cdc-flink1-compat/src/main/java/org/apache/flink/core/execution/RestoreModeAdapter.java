...
public final class RestoreModeAdapter {
    ...
    public static void setRestoreMode(Configuration configuration, String restoreModeStr) {
        RestoreMode restoreMode =
                ConfigurationUtils.convertValue(restoreModeStr, RestoreMode.class);
    ...
    public static SavepointRestoreSettings createSavepointRestoreSettings(
        ...
        return SavepointRestoreSettings.forPath(
                ...
                (RestoreMode) getRestoreMode(configuration));
    }

    private static RestoreMode convert(RestoreMode restoreMode) {
        switch (restoreMode) {
            case CLAIM:
                return RestoreMode.CLAIM;
            case NO_CLAIM:
                return RestoreMode.NO_CLAIM;
            case LEGACY:
                return RestoreMode.LEGACY;
            default:
