...
package com.ververica.cdc.connectors.refactor.refactor.source.validate;
...
/**
 * A Mysql Validator to validate the connected mysql database satisfies the cdc connector's
 * requirements.
 */
public class MySqlValidator implements Validator {
    ...
    public MySqlValidator(Properties dbzProperties, Dialect dialect) {
        this.dbzProperties = dbzProperties;
        this.sourceConfig = null;
        this.dialect = dialect;
    }

    public MySqlValidator(MySqlSourceConfig sourceConfig, Dialect dialect) {
    ...
    public void validate() {
        ...
        try {
            if (sourceConfig != null) {
                connection = dialect.openJdbcConnection(sourceConfig);
            } else {
