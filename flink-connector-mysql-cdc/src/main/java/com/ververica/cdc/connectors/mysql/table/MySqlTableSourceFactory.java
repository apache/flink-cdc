...
import com.ververica.cdc.connectors.mysql.source.connection.ConnectionPoolUtils;
...
public class MySqlTableSourceFactory implements DynamicTableSourceFactory {
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        helper.validateExcept(
                ...
                ConnectionPoolUtils.PROPERTIES_PREFIX);
        ...
        return new MySqlTableSource(
                ...
                heartbeatInterval,
                chunkKeyColumn,
                ConnectionPoolUtils.getConnectionPoolProperties(
