...
/**
 * Copied from Debezium project. Set correct binlog serverId & threadId. see
 * https://issues.redhat.com/browse/DBZ-4500
 *
 * <p>Line 374 : Use `offsetContext.setBinlogServerId(eventHeader.getServerId())` instead of
 * `offsetContext.setBinlogThread(eventHeader.getServerId())`. We should remove this class since we
 * bumped higher debezium version after 1.9.0.Final where the issue has been fixed.
 */
