...
/** Copied from https://github.com/debezium/debezium/blob/v1.5.4.Final/debezium-connector-mysql/src/main/java/io/debezium/connector/mysql/MySqlStreamingChangeEventSource.java 
 *  patched from DBZ-3949 from line 614 to line 619 to fix https://github.com/ververica/flink-cdc-connectors/issues/1017.
 *  
 *  We should remove this class after we bumped a higher debezium version where DBZ-3949 has been fixed.
 *  */
public class MySqlStreamingChangeEventSource implements StreamingChangeEventSource {
    ...
    protected void handleQueryEvent(Event event) throws InterruptedException {
        ...
        if (upperCasedStatementBegin.equals("INSERT ")
            ...
            // patched from DBZ-3949 in case to ignore none ROW format binlog
            LOGGER.warn(
                    "Received DML '"
                            + sql
    ...
    /** Class ReaderThreadLifecycleListener. */
