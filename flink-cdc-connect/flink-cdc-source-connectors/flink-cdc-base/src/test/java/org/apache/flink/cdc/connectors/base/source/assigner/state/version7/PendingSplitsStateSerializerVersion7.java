 ...
 */
public class PendingSplitsStateSerializerVersion7 {
    ...
    public static byte[] serialize(PendingSplitsState state) throws IOException {
        ...
        if (state instanceof SnapshotPendingSplitsStateVersion7) {
            out.writeInt(SNAPSHOT_PENDING_SPLITS_STATE_FLAG);
            serializeSnapshotPendingSplitsState((SnapshotPendingSplitsStateVersion7) state, out);
        } else if (state instanceof HybridPendingSplitsStateVersion7) {
            out.writeInt(HYBRID_PENDING_SPLITS_STATE_FLAG);
            serializeHybridPendingSplitsState((HybridPendingSplitsStateVersion7) state, out);
    ...
    private static void serializeHybridPendingSplitsState(
            HybridPendingSplitsStateVersion7 state, DataOutputSerializer out) throws IOException {
    ...
    private static void serializeSnapshotPendingSplitsState(
            SnapshotPendingSplitsStateVersion7 state, DataOutputSerializer out) throws IOException {
    ...
    private static void writeSplitFinishedCheckpointIds(
