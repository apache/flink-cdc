 ...
 */
public class HybridPendingSplitsStateVersion7 extends PendingSplitsState {
    private final SnapshotPendingSplitsStateVersion7 snapshotPendingSplits;
    private final boolean isStreamSplitAssigned;

    public HybridPendingSplitsStateVersion7(
            SnapshotPendingSplitsStateVersion7 snapshotPendingSplits,
    ...
    public SnapshotPendingSplitsStateVersion7 getSnapshotPendingSplits() {
