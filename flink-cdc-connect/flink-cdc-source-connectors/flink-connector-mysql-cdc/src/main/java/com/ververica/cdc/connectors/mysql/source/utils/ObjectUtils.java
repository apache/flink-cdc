...
public class ObjectUtils {
    ...
    /**
     * Compares two comparable objects.
     * When the compared objects are not instance of {@link Comparable} or instace of String,
     * we will compare them in db, ignore the charset of table effects the table-split result
     * exmaple:
     *   primaryKey: ['0000','1111','2222','3333','4444','aaaa','bbbb','cccc','ZZZZ']
     ...
     */
    @SuppressWarnings("unchecked")
    public static int compare(Object obj1, Object obj2, JdbcConnection jdbcConnection, TableId tableId, String splitColumn) throws SQLException {
        if(Objects.equals(obj1, obj2)) return 0;
        if(obj1 instanceof String && obj2 instanceof String){
            return StatementUtils.compareValueByQuery(obj1, obj2, jdbcConnection, tableId, splitColumn);
        }
        if (obj1 instanceof Comparable && obj1.getClass().equals(obj2.getClass())) {
            return ((Comparable) obj1).compareTo(obj2);
        } else {
