...
public class StatementUtils {
     ...
     * @throws SQLException
     */
    private static String queryColumnCollation(JdbcConnection jdbc, TableId tableId, String columnName) throws SQLException {
        final String template = "SHOW FULL COLUMNS FROM %s WHERE Field = '%s';";
        String querySql = String.format(template,
     ...
     *     {@code -1} if the {@code str1} is  less than the {@code str2} in mysql; and a value
     *     {@code 1} if the {@code str1} is numerically greater than the {@code str2} in mysql.
     * @throws SQLException
     */
    public static int compareValueByQuery(Object o1, Object o2, JdbcConnection jdbc, TableId tableId, String splitColumn) throws SQLException {
