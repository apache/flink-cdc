...
public class OceanBaseChunkSplitter implements JdbcSourceChunkSplitter {

    private static final Logger LOG = LoggerFactory.getLogger(OceanBaseChunkSplitter.class);
    ...
    public String buildSplitScanQuery(
        ...
        return OceanBaseUtils.buildSplitScanQuery(tableId, splitKeyType, isFirstSplit, isLastSplit);
    }
