...
public class OceanBaseOracleModeITCase extends OceanBaseTestBase {
    ...
    public OceanBaseOracleModeITCase() {
        ...
        this.username = "SYS@test";
        this.password = "";
        this.tenant = "test";
        this.schema = "SYS";
        this.configUrl =
                "http://127.0.0.1:8080/services?Action=ObRootServiceInfo&User_ID=${User_ID}&UID=${UID}&ObRegion=${ObRegion}";
    }
    ...
    protected Connection getJdbcConnection() throws SQLException {
        return DriverManager.getConnection(
                "jdbc:oceanbase://" + obServerHost + ":" + obServerPort + "/" + schema,
                username,
                password);
    }
