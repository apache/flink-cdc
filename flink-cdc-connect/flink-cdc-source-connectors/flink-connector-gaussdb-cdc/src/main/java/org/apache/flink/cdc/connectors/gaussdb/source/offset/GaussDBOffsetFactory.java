...
public class GaussDBOffsetFactory extends OffsetFactory {
    ...
    public Offset createOffset(Map<String, ?> offset) {
        return GaussDBOffset.of(offset);
    }

    public Offset createOffset(SourceRecord record) {
        return GaussDBOffset.of(record);
    }
