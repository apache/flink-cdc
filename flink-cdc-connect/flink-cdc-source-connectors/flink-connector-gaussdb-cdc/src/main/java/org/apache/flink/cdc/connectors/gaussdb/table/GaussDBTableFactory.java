...
import static org.apache.flink.cdc.connectors.gaussdb.source.config.GaussDBSourceOptions.SCAN_STARTUP_MODE;
import static org.apache.flink.cdc.connectors.gaussdb.source.config.GaussDBSourceOptions.SCHEMA_NAME;
import static org.apache.flink.cdc.connectors.gaussdb.source.config.GaussDBSourceOptions.SLOT_NAME;
    ...
    public DynamicTableSource createDynamicTableSource(DynamicTableFactory.Context context) {
        ...
        if (enableParallelRead) {
            ...
            checkState(
                    ...
                    "The GaussDB CDC connector does not support 'latest-offset' startup mode when 'scan.incremental.snapshot.enabled' is disabled, you can enable 'scan.incremental.snapshot.enabled' to use this startup mode.");
        }
