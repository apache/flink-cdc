...
/** Defines the supported metadata columns for {@link GaussDBTableSource}. */
public enum GaussDBReadableMetadata {
    ...
    GaussDBReadableMetadata(String key, DataType dataType, MetadataConverter converter) {
        this.key = key;
