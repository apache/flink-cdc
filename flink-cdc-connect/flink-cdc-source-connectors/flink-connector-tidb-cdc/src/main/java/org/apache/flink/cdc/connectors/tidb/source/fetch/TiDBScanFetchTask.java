...
public class TiDBScanFetchTask extends AbstractScanFetchTask {
    ...
    protected void executeDataSnapshot(Context context) throws Exception {
        ...
        SnapshotResult<EventOffsetContext> snapshotResult =
    ...
    public static class TiDBSnapshotSplitReadTask
            extends AbstractSnapshotChangeEventSource<TiDBPartition, EventOffsetContext> {
        ...
        private final EventOffsetContext offsetContext;
        ...
        public TiDBSnapshotSplitReadTask(
                ...
                EventOffsetContext previousOffset,
        ...
        @Override
        public SnapshotResult<EventOffsetContext> execute(
            ...
            AbstractSnapshotChangeEventSource.SnapshottingTask snapshottingTask =
                    getSnapshottingTask(partition, previousOffset);
        ...
        private static class TiDBSnapshotContext
                extends RelationalSnapshotChangeEventSource.RelationalSnapshotContext<
                        TiDBPartition, EventOffsetContext> {
        ...
        @Override
        protected SnapshotResult<EventOffsetContext> doExecute(
        ...
        protected SnapshottingTask getSnapshottingTask(
                TiDBPartition partition, EventOffsetContext previousOffset) {
