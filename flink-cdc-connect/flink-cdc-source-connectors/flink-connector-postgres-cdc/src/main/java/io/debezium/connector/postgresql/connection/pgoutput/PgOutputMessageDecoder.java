...
/**
 * copied from Debezium 1.9.8-Final with new method readUTF8String
...
public class PgOutputMessageDecoder extends AbstractMessageDecoder {
    ...
    /**
     *  Reads the replication stream up to the next null-terminator byte and return the contents as a utf-8 string
     * @param buffer The replication stream buffer
     * @return string read from the replication stream
     */
