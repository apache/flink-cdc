...
CREATE TABLE DB2INST1.QUOTE_PRIMARY_KEY (
  "KEY" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY
...
INSERT INTO DB2INST1.QUOTE_PRIMARY_KEY(NAME,DESCRIPTION,WEIGHT)
...
CALL ASNCDC.ADDTABLE('DB2INST1', 'QUOTE_PRIMARY_KEY');
