...
/** Metrics for Milvus sink writer. */
class MilvusSinkMetrics {

    static final MilvusSinkMetrics NOOP = new MilvusSinkMetrics(null);
    ...
    MilvusSinkMetrics(@Nullable SinkWriterMetricGroup metricGroup) {
        if (metricGroup == null) {
        ...
        this.flushCount = metricGroup.counter("milvusFlushCount");
        this.flushFailureCount = metricGroup.counter("milvusFlushFailureCount");
        this.retryCount = metricGroup.counter("milvusRetryCount");
        this.reconnectCount = metricGroup.counter("milvusReconnectCount");
        metricGroup.gauge("milvusPendingRows", () -> pendingRows);
        metricGroup.gauge("milvusLastFlushDurationMs", () -> lastFlushDurationMillis);
