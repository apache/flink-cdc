...
/** JDBC client wrapper for TDengine. */
public interface TDengineClientWrapper extends AutoCloseable {

    void execute(String sql) throws SQLException;

    List<TDengineColumnDescription> describeStable(TDengineTableInfo tableInfo) throws SQLException;
