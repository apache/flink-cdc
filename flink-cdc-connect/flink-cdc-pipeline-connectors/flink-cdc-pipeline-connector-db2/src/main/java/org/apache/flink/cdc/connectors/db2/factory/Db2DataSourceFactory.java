...
import static org.apache.flink.cdc.connectors.db2.source.Db2DataSourceOptions.HEARTBEAT_INTERVAL;
...
import static org.apache.flink.cdc.connectors.db2.source.Db2DataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_FILE;
import static org.apache.flink.cdc.connectors.db2.source.Db2DataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_POS;
import static org.apache.flink.cdc.connectors.db2.source.Db2DataSourceOptions.SCAN_STARTUP_TIMESTAMP_MILLIS;
...
public class Db2DataSourceFactory implements DataSourceFactory {
    ...
    public DataSource createDataSource(Context context) {
        ...
        return new Db2DataSource(configFactory);
    }
    ...
    private static List<String> getTableList(Db2SourceConfig sourceConfig, Selectors selectors) {
        return Db2SchemaUtils.listTables(sourceConfig, null).stream()
