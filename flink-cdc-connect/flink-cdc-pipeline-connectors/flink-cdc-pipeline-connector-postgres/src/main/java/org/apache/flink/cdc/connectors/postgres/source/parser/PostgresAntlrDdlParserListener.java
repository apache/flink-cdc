...
/**
 * Postgres main DDL parser listener class. It instantiates supported listeners, walks listeners
 * through every parsing rule and collects parsing exceptions.
 */
public class PostgresAntlrDdlParserListener extends PostgreSQLParserBaseListener
    ...
    public PostgresAntlrDdlParserListener(
            final PostgresAntlrDdlParser parser,
            LinkedList<SchemaChangeEvent> parsedEvents,
            PostgresConnectorConfig dbzConfig) {
        listeners.add(
                new PostgresAlterTableParserListener(listeners, parser, parsedEvents, dbzConfig));
    }
