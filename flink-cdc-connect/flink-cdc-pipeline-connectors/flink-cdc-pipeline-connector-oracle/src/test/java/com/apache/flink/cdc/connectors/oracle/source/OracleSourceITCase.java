...
import com.apache.flink.cdc.connectors.oracle.testutils.OracleTestUtils;
import com.apache.flink.cdc.connectors.oracle.testutils.TestTable;
...
import static com.apache.flink.cdc.connectors.oracle.testutils.OracleTestUtils.triggerFailover;
...
public class OracleSourceITCase extends OracleSourceTestBase {
    ...
    void testReadSingleTableWithSingleParallelism() throws Exception {
        testOracleParallelSource(
                1,
                OracleTestUtils.FailoverType.NONE,
                OracleTestUtils.FailoverPhase.NEVER,
    ...
    void testTaskManagerFailoverInSnapshotPhase() throws Exception {
        testOracleParallelSource(
                OracleTestUtils.FailoverType.TM,
                OracleTestUtils.FailoverPhase.SNAPSHOT,
                new String[] {"CUSTOMERS"});
    }
    ...
    void testTaskManagerFailoverInRedoLogPhase() throws Exception {
        testOracleParallelSource(
                OracleTestUtils.FailoverType.TM,
                OracleTestUtils.FailoverPhase.REDO_LOG,
                new String[] {"CUSTOMERS"});
    }
    ...
    void testJobManagerFailoverInSnapshotPhase() throws Exception {
        testOracleParallelSource(
                OracleTestUtils.FailoverType.JM,
                OracleTestUtils.FailoverPhase.SNAPSHOT,
                new String[] {"CUSTOMERS"});
    }
    ...
    private void testOracleParallelSource(
            OracleTestUtils.FailoverType failoverType,
            OracleTestUtils.FailoverPhase failoverPhase,
    ...
    private void testOracleParallelSource(
        ...
        if (failoverPhase == OracleTestUtils.FailoverPhase.SNAPSHOT && iterator.hasNext()) {
            triggerFailover(
                    failoverType,
                    jobId,
        ...
        if (failoverPhase == OracleTestUtils.FailoverPhase.REDO_LOG) {
            triggerFailover(
                    failoverType,
                    jobId,
                    miniClusterResource.get().getMiniCluster(),
