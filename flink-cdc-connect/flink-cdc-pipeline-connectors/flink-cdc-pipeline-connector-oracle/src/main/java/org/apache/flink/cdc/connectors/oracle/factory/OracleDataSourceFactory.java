...
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.CHUNK_KEY_EVEN_DISTRIBUTION_FACTOR_LOWER_BOUND;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.CHUNK_KEY_EVEN_DISTRIBUTION_FACTOR_UPPER_BOUND;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.CHUNK_META_GROUP_SIZE;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.CONNECTION_POOL_SIZE;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.CONNECT_MAX_RETRIES;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.CONNECT_TIMEOUT;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.HEARTBEAT_INTERVAL;
...
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_INCREMENTAL_CLOSE_IDLE_READER_ENABLED;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_CHUNK_SIZE;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_SNAPSHOT_FETCH_SIZE;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_MODE;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_FILE;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_GTID_SET;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_POS;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_SKIP_EVENTS;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_SPECIFIC_OFFSET_SKIP_ROWS;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCAN_STARTUP_TIMESTAMP_MILLIS;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SCHEMA_CHANGE_ENABLED;
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.SERVER_TIME_ZONE;
...
import static org.apache.flink.cdc.connectors.oracle.source.OracleDataSourceOptions.URL;
...
public class OracleDataSourceFactory implements DataSourceFactory {
    ...
    public DataSource createDataSource(Context context) {
        ...
        return new OracleDataSource(configFactory);
    }
    ...
    private static List<String> getTableList(OracleSourceConfig sourceConfig, Selectors selectors) {
