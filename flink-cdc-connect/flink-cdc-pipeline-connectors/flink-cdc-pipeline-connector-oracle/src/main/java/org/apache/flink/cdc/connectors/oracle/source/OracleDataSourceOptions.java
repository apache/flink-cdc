...
public class OracleDataSourceOptions {
    ...
    public static final String SCAN_STARTUP_SPECIFIC_OFFSET_PREFIX =
            "scan.startup.specific-offset.";
    public static final String SCAN_STARTUP_SPECIFIC_OFFSET_SCN_KEY = "scn";

    public static final ConfigOption<String> SCAN_STARTUP_SPECIFIC_OFFSET_SCN =
            ConfigOptions.key(
                            SCAN_STARTUP_SPECIFIC_OFFSET_PREFIX
                                    + SCAN_STARTUP_SPECIFIC_OFFSET_SCN_KEY)
                    .stringType()
                    .noDefaultValue()
                    .withDescription(
                            "Optional Oracle redo log SCN used in case of \"specific-offset\" startup mode.");
    ...
    public static final ConfigOption<String> DATABASE_CONNECTION_ADAPTER =
            ConfigOptions.key("debezium.database.connection.adapter")
                    ...
                    .withDescription(
                            "The adapter implementation that the connector uses when it streams database changes. You can set the following values: logminer, The connector uses the native Oracle LogMiner API. xstream:: The connector uses the Oracle XStreams API.");
