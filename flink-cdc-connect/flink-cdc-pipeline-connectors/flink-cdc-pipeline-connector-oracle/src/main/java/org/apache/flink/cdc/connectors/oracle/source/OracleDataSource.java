...
public class OracleDataSource implements DataSource, SupportsReadingMetadata {
    ...
    private OracleSourceConfigFactory configFactory;
    ...
    public EventSourceProvider getEventSourceProvider() {
        ...
        if (enableParallelRead) {
            ...
            OracleSourceReader<Event> oracleSourceReader =
                    new OracleSourceReader<>(deserializer, sourceConfig);
            DebeziumSourceFunction<Event> sourceFunction = oracleSourceReader.build();
