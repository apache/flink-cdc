...
public class JsonFormatOptionsUtil {
    ...
    public static TimestampFormat getTimestampFormat(Configuration config) {
     ...
     */
    public static org.apache.flink.formats.json.JsonFormatOptions.MapNullKeyMode getMapNullKeyMode(
            Configuration config) {
        String mapNullKeyMode = config.get(MAP_NULL_KEY_MODE);
        switch (mapNullKeyMode.toUpperCase()) {
            case JSON_MAP_NULL_KEY_MODE_FAIL:
                return org.apache.flink.formats.json.JsonFormatOptions.MapNullKeyMode.FAIL;
            case JSON_MAP_NULL_KEY_MODE_DROP:
                return org.apache.flink.formats.json.JsonFormatOptions.MapNullKeyMode.DROP;
            case JSON_MAP_NULL_KEY_MODE_LITERAL:
                return org.apache.flink.formats.json.JsonFormatOptions.MapNullKeyMode.LITERAL;
            default:
                throw new TableException(
                        String.format(
    ...
    public static void validateDecodingFormatOptions(Configuration tableOptions) {
    ...
    public static void validateEncodingFormatOptions(Configuration tableOptions) {
    ...
    static void validateTimestampFormat(Configuration tableOptions) {
