...
public final class EnumSerializer<T extends Enum<T>> extends TypeSerializer<T> {
    ...
    public static final class EnumSerializerSnapshot<T extends Enum<T>>
        ...
        public TypeSerializerSchemaCompatibility<T> resolveSchemaCompatibility(
                TypeSerializerSnapshot<T> newSerializer) {
            if (!(newSerializer instanceof EnumSerializerSnapshot)) {
                return TypeSerializerSchemaCompatibility.incompatible();
            }

            EnumSerializerSnapshot<T> newEnumSerializer = (EnumSerializerSnapshot<T>) newSerializer;
