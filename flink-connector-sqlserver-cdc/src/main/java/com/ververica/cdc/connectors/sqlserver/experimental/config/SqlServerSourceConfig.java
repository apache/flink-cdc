...
package com.ververica.cdc.connectors.sqlserver.experimental.config;
...
/**
 * Describes the connection information of the SqlServer database and the configuration information
...
public class SqlServerSourceConfig extends JdbcSourceConfig {
    ...
    private transient SqlServerConnectorConfig dbzMySqlConfig;
