...
import static org.apache.flink.cdc.common.configuration.MemorySize.MemoryUnit.BYTES;
import static org.apache.flink.cdc.common.configuration.MemorySize.MemoryUnit.GIGA_BYTES;
import static org.apache.flink.cdc.common.configuration.MemorySize.MemoryUnit.KILO_BYTES;
import static org.apache.flink.cdc.common.configuration.MemorySize.MemoryUnit.MEGA_BYTES;
import static org.apache.flink.cdc.common.configuration.MemorySize.MemoryUnit.TERA_BYTES;
import static org.apache.flink.cdc.common.configuration.MemorySize.MemoryUnit.hasUnit;
...
public class MemorySize implements java.io.Serializable, Comparable<MemorySize> {
    ...
    private static final List<MemorySize.MemoryUnit> ORDERED_UNITS =
    ...
    private String formatToString() {
        MemorySize.MemoryUnit highestIntegerUnit =
    ...
    private String formatToHumanReadableString() {
        MemorySize.MemoryUnit highestUnit =
                IntStream.range(0, ORDERED_UNITS.size())
                        .sequential()
     ...
     * @throws IllegalArgumentException Thrown, if the expression cannot be parsed.
     */
    public static MemorySize parse(String text, MemorySize.MemoryUnit defaultUnit)
    ...
    public static long parseBytes(String text) throws IllegalArgumentException {
        ...
        final long multiplier =
                parseUnit(unit).map(MemorySize.MemoryUnit::getMultiplier).orElse(1L);
    ...
    private static Optional<MemorySize.MemoryUnit> parseUnit(String unit) {
        if (matchesAny(unit, BYTES)) {
            ...
            throw new IllegalArgumentException(
                    "Memory size unit '"
                            ...
                            + MemorySize.MemoryUnit.getAllUnits());
        }

        return Optional.empty();
    }

    private static boolean matchesAny(String str, MemorySize.MemoryUnit unit) {
