    ...
    public static Schema applySchemaChangeEvent(Schema schema, SchemaChangeEvent event) {
        return event.visit(
                new SchemaChangeEventVisitor<Schema>() {
                    ...
                    @Override
                    public Schema visit(AlterColumnCommentEvent event) {
                        return applyAlterColumnCommentEvent(event, schema);
                    }
                    ...
                    @Override
                    public Schema visit(AlterTableCommentEvent event) {
                        return schema.copyComment(event.getTableComment());
                    }
