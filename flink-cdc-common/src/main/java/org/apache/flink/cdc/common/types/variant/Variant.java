...
/**
 * Copy from <a
 * href="https://github.com/apache/flink/blob/release-2.2.0/flink-core/src/main/java/org/apache/flink/types/variant/Variant.java">Variant.java</a>
 *
 * <p>Variant represent a semi-structured data.
 */
@PublicEvolving
public interface Variant {
    ...
    /**
     * Get the array size of variant.
     *
     * @throws VariantTypeException If this variant is not an array.
     */
    int arraySize() throws VariantTypeException;
