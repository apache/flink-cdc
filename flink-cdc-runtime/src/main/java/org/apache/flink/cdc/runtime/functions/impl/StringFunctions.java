...
public class StringFunctions {
    ...
    public static Boolean sqlLike(String str, String pattern) {
    ...
    public static Boolean sqlNotLike(String str, String pattern) {
        return LogicalFunctions.not(sqlLike(str, pattern));
    }
