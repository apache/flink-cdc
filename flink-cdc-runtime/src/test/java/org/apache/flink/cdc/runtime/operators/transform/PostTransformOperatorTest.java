...
public class PostTransformOperatorTest {
    ...
    private static final Schema TIMESTAMPDIFF_DATA_SCHEMA =
            Schema.newBuilder()
                    ...
                    .physicalColumn("start_timestamp_tz", DataTypes.TIMESTAMP_TZ())
                    .physicalColumn("end_timestamp_tz", DataTypes.TIMESTAMP_TZ())
                    .primaryKey("col1")
                    .build();
    private static final Schema EXPECTED_TIMESTAMPDIFF_DATA_SCHEMA =
            Schema.newBuilder()
                    ...
                    .physicalColumn("timestamp_timestamp_tz", DataTypes.INT())
                    .physicalColumn("timestamp_ltz_timestamp", DataTypes.INT())
                    .physicalColumn("timestamp_ltz_timestamp_ltz", DataTypes.INT())
                    .physicalColumn("timestamp_ltz_timestamp_tz", DataTypes.INT())
                    .physicalColumn("timestamp_tz_timestamp", DataTypes.INT())
                    .physicalColumn("timestamp_tz_timestamp_ltz", DataTypes.INT())
                    .physicalColumn("timestamp_tz_timestamp_tz", DataTypes.INT())
                    .primaryKey("col1")
                    .build();
                ...
                PostTransformOperator.newBuilder()
                        .addTransform(
                                ...
                                "col1, time_interval_unit,"
                                        ...
                                        + " TIMESTAMPDIFF(SECOND, start_timestamp, end_timestamp_tz) as timestamp_timestamp_tz,"
                                        ...
                                        + " TIMESTAMPDIFF(SECOND, start_timestamp_ltz, end_timestamp_tz) as timestamp_ltz_timestamp_tz,"
                                        + " TIMESTAMPDIFF(SECOND, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp,"
                                        + " TIMESTAMPDIFF(SECOND, start_timestamp_tz, end_timestamp_ltz) as timestamp_tz_timestamp_ltz,"
                                        + " TIMESTAMPDIFF(SECOND, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp_tz",
                        ...
                        .addTransform(
                                ...
                                "col1, time_interval_unit,"
                                        ...
                                        + " TIMESTAMPDIFF(MINUTE, start_timestamp, end_timestamp_tz) as timestamp_timestamp_tz,"
                                        ...
                                        + " TIMESTAMPDIFF(MINUTE, start_timestamp_ltz, end_timestamp_tz) as timestamp_ltz_timestamp_tz,"
                                        + " TIMESTAMPDIFF(MINUTE, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp,"
                                        + " TIMESTAMPDIFF(MINUTE, start_timestamp_tz, end_timestamp_ltz) as timestamp_tz_timestamp_ltz,"
                                        + " TIMESTAMPDIFF(MINUTE, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp_tz",
                        ...
                        .addTransform(
                                ...
                                "col1, time_interval_unit,"
                                        ...
                                        + " TIMESTAMPDIFF(HOUR, start_timestamp, end_timestamp_tz) as timestamp_timestamp_tz,"
                                        ...
                                        + " TIMESTAMPDIFF(HOUR, start_timestamp_ltz, end_timestamp_tz) as timestamp_ltz_timestamp_tz,"
                                        + " TIMESTAMPDIFF(HOUR, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp,"
                                        + " TIMESTAMPDIFF(HOUR, start_timestamp_tz, end_timestamp_ltz) as timestamp_tz_timestamp_ltz,"
                                        + " TIMESTAMPDIFF(HOUR, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp_tz",
                        ...
                        .addTransform(
                                ...
                                "col1, time_interval_unit,"
                                        ...
                                        + " TIMESTAMPDIFF(DAY, start_timestamp, end_timestamp_tz) as timestamp_timestamp_tz,"
                                        ...
                                        + " TIMESTAMPDIFF(DAY, start_timestamp_ltz, end_timestamp_tz) as timestamp_ltz_timestamp_tz,"
                                        + " TIMESTAMPDIFF(DAY, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp,"
                                        + " TIMESTAMPDIFF(DAY, start_timestamp_tz, end_timestamp_ltz) as timestamp_tz_timestamp_ltz,"
                                        + " TIMESTAMPDIFF(DAY, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp_tz",
                        ...
                        .addTransform(
                                ...
                                "col1, time_interval_unit,"
                                        ...
                                        + " TIMESTAMPDIFF(MONTH, start_timestamp, end_timestamp_tz) as timestamp_timestamp_tz,"
                                        ...
                                        + " TIMESTAMPDIFF(MONTH, start_timestamp_ltz, end_timestamp_tz) as timestamp_ltz_timestamp_tz,"
                                        + " TIMESTAMPDIFF(MONTH, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp,"
                                        + " TIMESTAMPDIFF(MONTH, start_timestamp_tz, end_timestamp_ltz) as timestamp_tz_timestamp_ltz,"
                                        + " TIMESTAMPDIFF(MONTH, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp_tz",
                        ...
                        .addTransform(
                                ...
                                "col1, time_interval_unit,"
                                        ...
                                        + " TIMESTAMPDIFF(YEAR, start_timestamp, end_timestamp_tz) as timestamp_timestamp_tz,"
                                        ...
                                        + " TIMESTAMPDIFF(YEAR, start_timestamp_ltz, end_timestamp_tz) as timestamp_ltz_timestamp_tz,"
                                        + " TIMESTAMPDIFF(YEAR, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp,"
                                        + " TIMESTAMPDIFF(YEAR, start_timestamp_tz, end_timestamp_ltz) as timestamp_tz_timestamp_ltz,"
                                        + " TIMESTAMPDIFF(YEAR, start_timestamp_tz, end_timestamp) as timestamp_tz_timestamp_tz",
                ...
                DataChangeEvent.insertEvent(
                        ...
                        recordDataGenerator.generate(
                                new Object[] {
                                    ...
                                    ZonedTimestampData.of(0, 0, "UTC"),
                                    ZonedTimestampData.of(253402271999000L, 0, "UTC")
                                }));
