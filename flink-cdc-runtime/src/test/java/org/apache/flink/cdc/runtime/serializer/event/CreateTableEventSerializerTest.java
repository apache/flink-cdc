...
class CreateTableEventSerializerTest extends SerializerTestBase<CreateTableEvent> {
    ...
    @Override
    protected Class<CreateTableEvent> getTypeClass() {
        return CreateTableEvent.class;
    }

    @Override
    protected CreateTableEvent[] getTestData() {
        Schema schema =
                Schema.newBuilder()
                        .comment("test")
        ...
        return new CreateTableEvent[] {
            new CreateTableEvent(TableId.tableId("table"), schema),
            new CreateTableEvent(TableId.tableId("schema", "table"), schema),
            new CreateTableEvent(TableId.tableId("namespace", "schema", "table"), schema)
        };
    }
}
