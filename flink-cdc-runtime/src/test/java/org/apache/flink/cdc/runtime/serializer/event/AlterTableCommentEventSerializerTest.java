...
/** A test for the {@link AlterTableCommentEventSerializer}. */
public class AlterTableCommentEventSerializerTest
    ...
    protected AlterTableCommentEvent[] getTestData() {
        String comment = "This is a table comment.";
        return new AlterTableCommentEvent[] {
            new AlterTableCommentEvent(TableId.tableId("table"), comment),
            new AlterTableCommentEvent(TableId.tableId("schema", "table"), comment),
            new AlterTableCommentEvent(TableId.tableId("namespace", "schema", "table"), comment)
        };
    }
}
