...
public class UdfE2eITCase extends PipelineTestEnvironment {
    ...
    @Test
    public void testUserDefinedFunctionsInJavaInBatchMode() throws Exception {
    ...
    @Test
    public void testUserDefinedFunctionsInScalaInBatchMode() throws Exception {
    ...
    @Test
    public void testFlinkCompatibleScalarFunctionsInJavaInBatchMode() throws Exception {
    ...
    @Test
    public void testFlinkCompatibleScalarFunctionsInScalaInBatchMode() throws Exception {
