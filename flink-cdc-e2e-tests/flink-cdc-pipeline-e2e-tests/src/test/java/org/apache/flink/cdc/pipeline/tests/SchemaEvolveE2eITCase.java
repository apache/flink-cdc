    ...
    public void testSchemaEvolve() throws Exception {
        testGenericSchemaEvolution(
                ...
                Arrays.asList(
                        ...
                        "AlterColumnTypeEvent{tableId=%s.members, typeMapping={age=DOUBLE}, oldTypeMapping={age=INT}, columnDefaultValue={}}",
    ...
    public void testLenientWithRoute() throws Exception {
        ...
        List<String> expectedTaskManagerEvents =
                Arrays.asList(
                        ...
                        "AlterColumnTypeEvent{tableId=%s.redirect, typeMapping={age=DOUBLE}, oldTypeMapping={age=INT}, columnDefaultValue={}}",
