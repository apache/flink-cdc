...
public class RouteE2eITCase extends PipelineTestEnvironment {
    ...
    public void testDefaultRoute() throws Exception {
        ...
        validateResult(
                ...
                "AlterColumnTypeEvent{tableId=%s.TABLEGAMMA, typeMapping={VERSION=VARCHAR(19)}, oldTypeMapping={VERSION=VARCHAR(17)}, columnDefaultValue={}}",
    ...
    public void testMergeTableRoute() throws Exception {
        ...
        validateResult(
                ...
                "AlterColumnTypeEvent{tableId=%s.ALL, typeMapping={VERSION=STRING}, oldTypeMapping={VERSION=VARCHAR(17)}, columnDefaultValue={}}",
    ...
    public void testMultipleRoute() throws Exception {
        ...
        validateResult(
                ...
                "AlterColumnTypeEvent{tableId=NEW_%s.BETAGAMM, typeMapping={VERSION=STRING}, oldTypeMapping={VERSION=VARCHAR(17)}, columnDefaultValue={}}",
    ...
    public void testReplacementSymbol() throws Exception {
        ...
        validateResult(
                ...
                "AlterColumnTypeEvent{tableId=NEW_%s.NEW_TABLEGAMMA, typeMapping={VERSION=VARCHAR(19)}, oldTypeMapping={VERSION=VARCHAR(17)}, columnDefaultValue={}}",
