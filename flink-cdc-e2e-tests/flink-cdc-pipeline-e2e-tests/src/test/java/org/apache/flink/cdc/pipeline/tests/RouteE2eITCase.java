...
public class RouteE2eITCase extends PipelineTestEnvironment {
    ...
    @Test
    public void testDefaultRouteInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testMergeTableRouteInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testPartialRouteInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testMultipleRouteInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testOneToManyRouteInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testMergeTableRouteWithTransformInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testReplacementSymbolInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
