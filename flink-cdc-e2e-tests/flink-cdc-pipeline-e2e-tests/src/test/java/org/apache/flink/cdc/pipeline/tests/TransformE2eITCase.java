...
public class TransformE2eITCase extends PipelineTestEnvironment {
    ...
    @Test
    public void testHeteroSchemaTransformInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testMultipleTransformRuleInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testAssortedSchemaTransformInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testWildcardSchemaTransformInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testWildcardWithMetadataColumnTransformInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testMultipleHittingTableInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testMultipleTransformWithDiffRefColumnInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testTransformWithCastInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
    ...
    @Test
    public void testTemporalFunctionsInBatchMode() throws Exception {
        String pipelineJob =
                String.format(
                        "source:\n"
                                + "  type: mysql\n"
