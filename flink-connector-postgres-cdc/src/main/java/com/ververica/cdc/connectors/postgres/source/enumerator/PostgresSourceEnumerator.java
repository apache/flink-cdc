...
public class PostgresSourceEnumerator extends IncrementalSourceEnumerator {
    ...
    public void start() {
        ...
        // currently all starup modes need read the stream split
        createSlotForStreamSplit();

        super.start();
    }

    private void createSlotForStreamSplit() {
        try {
            ...
            throw new FlinkRuntimeException("Create Slot For Stream Split failed due to ", t);
        }
    }
}
